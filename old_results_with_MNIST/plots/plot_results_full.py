...
file_path = "summary_DONT_DELETE_old.txt"
data = []
...
plt.savefig("acc_vs_p_by_N_old.pdf", dpi=300)
...
plt.savefig("acc_vs_N_by_equiv_old.pdf", dpi=300)
...
plt.savefig("acc_vs_N_by_p_old.pdf", dpi=300)
plt.show()
